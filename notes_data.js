...
const lecturesData = [
  {
    "id": 1,
    "week": 1,
    "title": "Soft Skills Promo",
    "youtubeId": "oZWViNKmyZU",
    "objectives": [
      "Introduction to the Soft Skills curriculum and syllabus structure.",
      "Understand the global scope and applicability of soft skills in diverse professions.",
      "Overview of weekly learning goals from Week 1 to Week 12."
    ],
    "notes": "\n    <div class=\"space-y-6\">\n      <div class=\"border-l-4 border-amber-500 pl-4\">\n        <h3 class=\"text-xl font-bold text-slate-800\">Soft Skills Course Promo</h3>\n        <p class=\"text-sm text-slate-500 mt-1\">Official course syllabus overview by Prof. Binod Mishra.</p>\n      </div>\n\n      <div class=\"bg-amber-50/50 p-6 rounded-2xl border border-amber-100\">\n        <h4 class=\"font-bold text-amber-900 text-sm mb-2\"><i class=\"bi bi-info-circle-fill\"></i> Syllabus Overview</h4>\n        <p class=\"text-xs text-slate-700 leading-relaxed\">\n          Welcome to the official 12-week NPTEL Soft Skills course. This promotional lecture introduces the instructor, course objectives, weekly assignments weight, and final grading breakdown. It outlines how professional success is powered by dynamic behavioral traits and communication competencies.\n        </p>\n      </div>\n    </div>\n  ",
    "quiz": [
      {
        "question": "What is the duration of the NPTEL Soft Skills course?",
        "options": [
          "4 Weeks",
          "8 Weeks",
          "12 Weeks",
        ...
        "answer": 2,
        "explanation": "This is a comprehensive 12-week online course consisting of 60 lectures and weekly assignments."
      },
      {
        "question": "Which institute offers this online MOOC course?",
        "options": [
          "IIT Bombay",
          "IIT Delhi",
          "IIT Roorkee",
        ...
        "answer": 2,
        "explanation": "The course is taught by Prof. Binod Mishra from the Humanities and Social Sciences department of IIT Roorkee."
      },
      {
        "question": "What is the final certification score weight for weekly assignments?",
        "options": [
          "10%",
          "25%",
          "50%",
        ...
        "answer": 1,
        "explanation": "Weekly assignments make up 25% of the final certified score (best 8 assignments out of 12)."
      }
    ]
  },
  {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": [
          ...
          "Eye contact",
          "Physical distance between chairs"
        ],
        "answer": 1,
    ...
    "quiz": [
      {
        ...
        "options": [
          "The study of voice pitch",
          "The study of touch",
          "The study of eye movement",
          "The study of physical distance"
        ],
        "answer": 1,
  ...
  },
  {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": [
          "Monthly circulars",
          "An open-door policy and digital suggestion portal",
          "Company rulebook distribution",
  ...
  },
  {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": [
          "Weekly employee attendance log",
          "Project feasibility study report",
          "Monthly financial balance sheet",
          "Standard corporate rules handbook"
        ],
        "answer": 1,
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": [
          ...
          "In the prefatory section, before the table of contents.",
          "Inside the findings chapter.",
          "It is sent in a separate email only."
        ],
        "answer": 1,
  ...
  },
  {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": [
          "The external client",
          "A designated scribe or secretary",
  ...
  },
  {
    ...
    "youtubeId": "",
    "objectives": [
      "Define leadership and distinguish it from raw management.",
      "Analyze different leadership styles (autocratic, democratic, laissez-faire, transformational).",
      "Explore key emotional and behavioral qualities of an effective leader."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">LEADERSHIP AND PEOPLE MANAGEMENT</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Inspiring teams and driving organizational vision.</p>\n          </div>\n\n          <div class=\"grid md:grid-cols-2 gap-6 text-xs text-slate-700\">\n            <div class=\"bg-white p-5 rounded-xl border border-slate-200 space-y-3\">\n              <h4 class=\"font-bold text-amber-800 text-xs\">Management vs. Leadership</h4>\n              <p class=\"leading-relaxed\">\n                While <strong>managers</strong> focus on maintaining order, planning budgets, and managing systems, <strong>leaders</strong> focus on alignment, inspiration, motivating people, and establishing long-term visions.\n              </p>\n            </div>\n            <div class=\"bg-slate-900 text-white p-5 rounded-xl border border-slate-700 space-y-2\">\n              <h4 class=\"font-bold text-amber-500 text-xs\">Four Primary Styles</h4>\n              <ul class=\"space-y-1.5 text-xxs text-slate-300\">\n                <li>• <strong>Autocratic:</strong> Centralized decision-making, minimal input from subordinates.</li>\n                <li>• <strong>Democratic:</strong> Collaborative decision-making, values team feedback.</li>\n                <li>• <strong>Laissez-Faire:</strong> Complete delegation, gives teams autonomy to decide.</li>\n                <li>• <strong>Transformational:</strong> Focuses on vision, values, and elevating group capabilities.</li>\n              </ul>\n            </div>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "Which leadership style involves complete delegation of authority to team members?",
        "options": [
          "Autocratic",
          "Democratic",
          "Laissez-Faire",
        ...
        "answer": 2,
        "explanation": "Laissez-Faire involves giving full autonomy and decision-making power to subordinates."
      },
      {
        "question": "How do leaders primarily motivate teams compared to managers?",
        "options": [
          "By implementing strict punch-in clocks.",
          "By establishing a shared vision and inspiring trust.",
          "By threatening salary cuts.",
          "By avoiding meetings completely."
        ],
        "answer": 1,
        "explanation": "Leadership is built on vision, trust, and aligning people toward a shared collective goal."
      },
      {
        "question": "Which of the following is a core characteristic of transformational leaders?",
        "options": [
          "Resisting all changes.",
          "Inspiriting team members by elevating their values and skill sets.",
          "Micro-managing daily activities.",
          "Working in isolation."
        ],
        "answer": 1,
        "explanation": "Transformational leaders focus on inspiration, growth, and transforming the culture of the team."
      }
    ]
  },
  {
    "id": 43,
    "week": 9,
    "title": "Group Discussion: Part I",
    "youtubeId": "",
    "objectives": [
      "Analyze the evaluation parameters of a professional Group Discussion (GD).",
      "Understand the different roles one can assume in a GD.",
      "Explore strategies to handle conflicts and state arguments constructively."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">GROUP DISCUSSION MECHANICS</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Succeeding in competitive group interviews.</p>\n          </div>\n\n          <div class=\"bg-white p-6 rounded-2xl border border-slate-200 space-y-4\">\n            <h4 class=\"font-bold text-slate-800 text-sm\">Key Roles in a GD</h4>\n            <div class=\"grid md:grid-cols-4 gap-4 text-xs\">\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <span class=\"font-bold text-amber-600 block mb-1\">01. Initiator</span>\n                <p class=\"text-xxs text-slate-500\">Starts the discussion and sets the conceptual framework.</p>\n              </div>\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <span class=\"font-bold text-amber-600 block mb-1\">02. Moderator</span>\n                <p class=\"text-xxs text-slate-500\">Maintains flow and redirects focus back to the topic.</p>\n              </div>\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <span class=\"font-bold text-amber-600 block mb-1\">03. Contributor</span>\n                <p class=\"text-xxs text-slate-500\">Feeds the discussion with fresh data and perspectives.</p>\n              </div>\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <span class=\"font-bold text-amber-600 block mb-1\">04. Summarizer</span>\n                <p class=\"text-xxs text-slate-500\">Concludes the GD by summarizing all views objectively.</p>\n              </div>\n            </div>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What is a major pitfall to avoid during a Group Discussion?",
        "options": [
          "Listening carefully to others.",
          "Dominating the talk aggressively and shouting down other participants.",
          "Speaking in a clear, modulated tone.",
          "Waiting for a turn to contribute."
        ],
        "answer": 1,
        "explanation": "Aggressive interruption and dominance signal poor emotional intelligence and lack of collaboration skills."
      },
      {
        "question": "Who is responsible for concluding the group discussion objectively?",
        "options": [
          "The Initiator",
          "The Moderator",
          "The Summarizer",
        ...
        "answer": 2,
        "explanation": "The Summarizer wraps up the discussion by outlining the major themes and consensus points."
      },
      {
        "question": "GD evaluation criteria focus heavily on:",
        "options": [
          "How loud a participant can shout.",
          "Subject knowledge, communication skills, active listening, and team spirit.",
          "The physical appearance of participants.",
          "Memorizing facts without understanding context."
        ],
        "answer": 1,
        "explanation": "GDs assess collaborative skills, logic, articulation, and how well you work within team dynamics."
      }
    ]
  },
  {
    "id": 44,
    "week": 9,
    "title": "Group Discussion: Part II",
    "youtubeId": "",
    "objectives": [
      "Understand the role of the Chairperson and Secretary in business meetings.",
      "Explore structures to maintain meeting order and address questions.",
      "Analyze post-meeting actions to drive execution."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">MEETING MODERATION</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Running collaborative and outcome-oriented business meetings.</p>\n          </div>\n\n          <div class=\"bg-slate-900 text-white p-6 rounded-2xl text-xs space-y-3\">\n            <h4 class=\"font-bold text-amber-500\">Meeting Roles</h4>\n            <p class=\"text-slate-300\">\n              • <strong>Chairperson:</strong> Presides over the meeting, controls the agenda flow, and maintains order.\n            </p>\n            <p class=\"text-slate-300\">\n              • <strong>Secretary/Scribe:</strong> Sends notices, assists in logistics, and compiles the official minutes.\n            </p>\n            <p class=\"text-slate-300\">\n              • <strong>Participants:</strong> Actively contribute to discussions and carry out assigned tasks.\n            </p>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "Who is responsible for maintaining order and moderating the agenda during a business meeting?",
        "options": [
          "The external vendor",
          "The Chairperson",
          "The Scribe",
          "The lowest-ranking associate"
        ],
        "answer": 1,
        "explanation": "The Chairperson presides over the meeting, managing the speaking turns and keeping discussions on-topic."
      },
      {
        "question": "What should be sent alongside the meeting notice?",
        "options": [
          "The final invoice",
          "The meeting Agenda",
        ...
        "answer": 1,
        "explanation": "The Agenda must accompany the notice so that participants know what will be discussed and can prepare."
      },
      {
        "question": "Which of the following describes the role of meeting participants?",
        "options": [
          "Remaining silent throughout.",
          "Contributing constructively and adhering to the guidelines of the Chairperson.",
          "Reading emails unrelated to the topic.",
          "Leaving the room without notice."
        ],
        "answer": 1,
        "explanation": "Participants must engage productively, listen to others, and respect the boundaries set by the chair."
      }
    ]
  },
  {
    ...
    "youtubeId": "",
    "objectives": [
      "Analyze adaptability as a core behavioral trait in modern careers.",
      "Explore reskilling and upskilling strategies.",
      "Understand cognitive flexibility in facing corporate restructuring."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">BEHAVIORAL ADAPTABILITY</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Thriving in dynamic and rapidly evolving workplace environments.</p>\n          </div>\n\n          <div class=\"bg-white p-6 rounded-2xl border border-slate-200 space-y-4\">\n            <h4 class=\"font-bold text-slate-800 text-sm\">Reskilling vs. Upskilling</h4>\n            <div class=\"grid md:grid-cols-2 gap-6 text-xs text-slate-655\">\n              <div class=\"p-4 bg-orange-50/30 border border-orange-100 rounded-xl\">\n                <span class=\"font-bold text-amber-800 block mb-1\">Reskilling</span>\n                <p>Learning entirely new skills to transition into a completely different role or career track.</p>\n              </div>\n              <div class=\"p-4 bg-orange-50/30 border border-orange-100 rounded-xl\">\n                <span class=\"font-bold text-amber-800 block mb-1\">Upskilling</span>\n                <p>Improving and upgrading existing skill sets to become more efficient in your current role.</p>\n              </div>\n            </div>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What does 'Reskilling' refer to?",
        "options": [
          "Doing the same task repeatedly.",
          "Learning entirely new skills to transition to a different job profile.",
          "Demanding a promotion without training.",
          "Refusing to use new software tools."
        ],
        "answer": 1,
        "explanation": "Reskilling is the process of learning new skills to handle a different job function."
      },
      {
        "question": "Which mindset is crucial for personal and career adaptability?",
        "options": [
          "Fixed Mindset",
          "Growth Mindset",
          "Status Quo Mindset",
        ...
        "answer": 1,
        "explanation": "A Growth Mindset views challenges as opportunities to learn and adapt, which supports lifelong reskilling."
      },
      {
        "question": "In organizational terms, adaptability helps employees:",
        "options": [
          "Complain about new systems.",
          "Manage transitions, learn new processes, and remain productive during changes.",
          "Resign immediately when technologies shift.",
          "Micro-manage their peers."
        ],
        "answer": 1,
        "explanation": "Adaptable workers can pivot during restructuring, minimizing downtime and maintaining team morale."
      }
    ]
  },
  {
    "id": 46,
    "week": 9,
    "title": "Adaptability and Work Ethics",
    "youtubeId": "",
    "objectives": [
      "Define professional integrity and workplace ethics.",
      "Analyze ethical dilemmas and professional conflict of interest.",
      "Explore accountability, transparency, and personal responsibility."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-805\">WORKPLACE ETHICS & INTEGRITY</h3>\n            <p class=\"text-xs text-slate-500 mt-1\">Maintaining professional codes of conduct and accountability.</p>\n          </div>\n\n          <div class=\"bg-amber-50/50 p-6 rounded-2xl border border-amber-100/50 text-sm\">\n            <p class=\"italic text-slate-700 leading-relaxed\">\n              <strong>Professional Integrity:</strong> The consistency of actions, values, methods, and principles. It is the practice of doing the right thing even when no one is watching.\n            </p>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What is the core definition of professional integrity?",
        "options": [
          "Doing whatever it takes to make money.",
          "Adhering to moral and ethical codes even when unsupervised.",
          "Blaming others for team failures.",
          "Never asking for help."
        ],
        "answer": 1,
        "explanation": "Integrity means being honest and consistent in your ethical values regardless of scrutiny."
      },
      {
        "question": "What does 'Accountability' mean in the workplace?",
        "options": [
          "Refusing to take blame.",
          "Accepting responsibility for your work outcomes, decisions, and mistakes.",
          "Checking team members' punch cards.",
          "Delegating all difficult work."
        ],
        "answer": 1,
        "explanation": "Accountability is taking ownership of your tasks and being answerable for the results."
      },
      {
        "question": "A conflict of interest occurs when:",
        "options": [
          "A manager gives positive feedback.",
          "Personal interests interfere with professional duties and objectivity.",
          "An employee works late.",
          "Two departments collaborate."
        ],
        "answer": 1,
        "explanation": "Conflicts of interest arise when personal gain threatens professional judgment and fairness."
      }
    ]
  },
  {
    ...
    "youtubeId": "",
    "objectives": [
      "Explore advanced verbal delivery dynamics (pitch, volume, rate).",
      "Understand vocalics and paralanguage features in public speeches.",
      "Learn techniques to maintain clarity, pause effectively, and command attention."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">VOCAL DYNAMICS & DELIVERIES</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Mastering verbal communication for large audiences.</p>\n          </div>\n\n          <div class=\"bg-slate-900 text-white p-6 rounded-2xl text-xs space-y-4\">\n            <h4 class=\"font-bold text-amber-500\">Parameters of Vocalics</h4>\n            <ul class=\"space-y-3 text-slate-300\">\n              <li>• <strong>Volume:</strong> Adjusting loudness to ensure the back row can hear without shouting.</li>\n              <li>• <strong>Pitch Modulation:</strong> Avoiding monotone speaking; shifting pitch to emphasize critical points.</li>\n              <li>• <strong>Rate of Speech:</strong> Pacing delivery (120-150 words per minute) to allow comprehension.</li>\n              <li>• <strong>Pause Control:</strong> Using short pauses before and after key statements for dramatic emphasis.</li>\n            </ul>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What is pitch modulation used for?",
        "options": [
          "To speak as fast as possible.",
          "To avoid a monotone voice and emphasize important ideas.",
          "To make the speech louder.",
          "To ignore grammar rules."
        ],
        "answer": 1,
        "explanation": "Varying pitch keeps listeners engaged and flags key concepts or emotional shifts."
      },
      {
        "question": "What is the recommended average rate of speech for clear public speaking?",
        "options": [
          "50-70 words per minute",
          "120-150 words per minute",
          "250-300 words per minute",
          "Over 400 words per minute"
        ],
        "answer": 1,
        "explanation": "Speaking at 120-150 words per minute provides the perfect balance of clarity and steady flow."
      },
      {
        "question": "Why are intentional pauses valuable in public speaking?",
        "options": [
          "They show the speaker is unprepared.",
          "They give the audience time to absorb information and create emphasis.",
          "They are used to fill up time.",
          "They make the speech sound unstructured."
        ],
        "answer": 1,
        "explanation": "Pauses allow critical concepts to sink in and give the audience time to reflect on key statements."
      }
    ]
  },
  {
    "id": 48,
    "week": 10,
    "title": "Oral Presentations, Speeches, and Debates",
    "youtubeId": "",
    "objectives": [
      "Explore patterns and structures of presentation layouts.",
      "Learn demographic and technical audience mapping.",
      "Analyze slide design rules (Rule of Thirds, visual hierarchy)."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">SLIDE ARCHITECTURE & AUDIENCE MAPPING</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Designing clean, readable, and highly informative slides.</p>\n          </div>\n\n          <div class=\"bg-white p-6 rounded-2xl border border-slate-200 text-xs space-y-4\">\n            <h4 class=\"font-bold text-slate-800 text-sm\">Key Layout Guidelines</h4>\n            <ul class=\"space-y-2 text-slate-655\">\n              <li>• <strong>Visual Hierarchy:</strong> Put the most important information in large bold fonts at the top.</li>\n              <li>• <strong>Contrast:</strong> Always use dark text on light backgrounds (or vice-versa) for legibility.</li>\n              <li>• <strong>Whitespace:</strong> Keep 30-40% of the slide free of text and assets to avoid clutter.</li>\n            </ul>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What does visual hierarchy on a slide accomplish?",
        "options": [
          "It fills the slide completely.",
          "It guides the audience's eyes to the most critical information first.",
          "It makes text hard to read.",
          "It forces you to use multiple colors."
        ],
        "answer": 1,
        "explanation": "Hierarchy uses size, weight, and layout to ensure the core message stands out immediately."
      },
      {
        "question": "What is a recommended background contrast practice?",
        "options": [
          "Gray text on a white background.",
          "Dark text on a light background, or bright text on a dark background.",
          "Yellow text on a white background.",
          "Purple text on a blue background."
        ],
        "answer": 1,
        "explanation": "High contrast is essential for readability, especially on typical low-end meeting projectors."
      },
      {
        "question": "Why is whitespace important on presentation slides?",
        "options": [
          "It shows you didn't finish preparing.",
          "It prevents visual clutter and allows important points to stand out.",
          "It is used to insert advertisements.",
          "It makes the slides look unprofessional."
        ],
        "answer": 1,
        "explanation": "Generous margins and whitespace prevent slides from looking overcrowded and overwhelming."
      }
    ]
  },
  {
    "id": 49,
    "week": 10,
    "title": "Combating Nervousness",
    "youtubeId": "",
    "objectives": [
      "Contrast formal speeches with spontaneous debates.",
      "Analyze structural phases of public speeches (introduction, body, conclusion).",
      "Explore refutation and rebuttals strategies in formal debates."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-805\">SPEECH STRUCTURES</h3>\n            <p class=\"text-xs text-slate-500 mt-1\">Formulating persuasive public deliveries and debate arguments.</p>\n          </div>\n\n          <div class=\"bg-amber-50/50 p-6 rounded-2xl border border-amber-100/50 text-xs space-y-4\">\n            <h4 class=\"font-bold text-amber-900 text-sm\">Three Key Pillars of a Speech</h4>\n            <p><strong>1. Introduction (Hook):</strong> Grabs attention, introduces the core topic, and establishes rapport.</p>\n            <p><strong>2. Body (Content):</strong> Delivers 2-3 main arguments backed by evidence, studies, or statistics.</p>\n            <p><strong>3. Conclusion (Call to Action):</strong> Re-emphasizes the main thesis and leaves a memorable takeaway.</p>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What is the primary objective of the introduction phase of a speech?",
        "options": [
          "To read the entire bibliography.",
          "To hook the audience's attention and establish rapport.",
          "To summarize the entire discussion.",
          "To answer questions from the floor."
        ],
        "answer": 1,
        "explanation": "The introduction must capture attention quickly using quotes, questions, or statistics."
      },
      {
        "question": "What should be delivered in the body of a speech?",
        "options": [
          "An apology for lack of time.",
          "A structured set of arguments backed by logical evidence.",
          "Unrelated personal anecdotes.",
          "A repeat of the introduction."
        ],
        "answer": 1,
        "explanation": "The body contains the core arguments, facts, and logical progressions of your topic."
      },
      {
        "question": "What is the role of a rebuttal in formal debates?",
        "options": [
          "Agreeing with all opposing points.",
          "Logically disproving the opponent's arguments with evidence and reasoning.",
          "Interrupting the opponent mid-sentence.",
          "Refusing to speak on stage."
        ],
        "answer": 1,
        "explanation": "Rebuttals identify logical fallacies or lack of evidence in opposing statements to strengthen your stance."
      }
    ]
  },
  {
    "id": 50,
    "week": 10,
    "title": "Patterns and Methods of Presentation",
    "youtubeId": "",
    "objectives": [
      "Analyze physiological triggers of stage anxiety.",
      "Explore strategies to manage adrenaline before presentations.",
      "Learn breathing and muscle-relaxation exercises."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">STAGE COGNITIVE CONTROL</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Channelling nervous energy into presentation presence.</p>\n          </div>\n\n          <div class=\"bg-white p-6 rounded-2xl border border-slate-200 space-y-4\">\n            <h4 class=\"font-bold text-slate-850 text-sm\">Four Steps to Control Anxiety</h4>\n            <div class=\"grid md:grid-cols-2 gap-4 text-xs text-slate-655\">\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <strong>1. Slow Breathing:</strong> Deep breathing (inhaling for 4s, holding for 4s, exhaling for 4s) slows heart rate.\n              </div>\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <strong>2. Positive Visualization:</strong> Imagine delivering a successful presentation and receiving positive feedback.\n              </div>\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <strong>3. Familiarize Workspace:</strong> Arrive early, test the projector, pointer, and acoustics.\n              </div>\n              <div class=\"p-3 bg-slate-50 rounded-xl\">\n                <strong>4. Rehearsal:</strong> Practice aloud in front of friends or a mirror at least 3 times.\n              </div>\n            </div>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "How does deep breathing help reduce stage fright?",
        "options": [
          "It makes you fall asleep.",
          "It helps slow down the heart rate and calm physiological adrenaline spikes.",
          "It increases anxiety.",
          "It affects your posture negatively."
        ],
        "answer": 1,
        "explanation": "Deep breathing regulates the nervous system, reducing tremors and stabilizing the voice."
      },
      {
        "question": "What is positive visualization?",
        "options": [
          "Failing to plan for the presentation.",
          "Mental rehearsal of a successful speech and positive audience reaction.",
          "Watching unrelated movies.",
          "Drawing designs on slides."
        ],
        "answer": 1,
        "explanation": "Visualizing success builds confidence and reduces self-doubt before walking on stage."
      },
      {
        "question": "Familiarizing yourself with the presentation room in advance helps:",
        "options": [
          "Avoid speaking.",
          "Build confidence, test technology, and reduce ambient anxiety.",
          "Find exits to escape early.",
          "Increase stage fright."
        ],
        "answer": 1,
        "explanation": "Knowing the setup prevents unexpected technical glitches that might trigger panic."
      }
    ]
  },
  {
    "id": 51,
    "week": 10,
    "title": "Oral Presentation: Planning & Preparation",
    "youtubeId": "",
    "objectives": [
      "Analyze different methods to organize presentation flows.",
      "Compare chronological, spatial, topical, and problem-solution structures.",
      "Learn strategies for handling Q&A sessions effectively."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-805\">PRESENTATION PATTERNS & FLOWS</h3>\n            <p class=\"text-xs text-slate-500 mt-1\">Organizing ideas and resolving audience questions.</p>\n          </div>\n\n          <div class=\"bg-slate-900 text-white p-6 rounded-2xl text-xs space-y-4\">\n            <h4 class=\"font-bold text-amber-500\">Flow Patterns</h4>\n            <div class=\"grid md:grid-cols-3 gap-4 text-xxs text-slate-300\">\n              <div class=\"p-3 bg-slate-800 rounded-xl border border-slate-700\">\n                <strong>Chronological:</strong> Structured along a timeline (past, present, future). Best for histories.\n              </div>\n              <div class=\"p-3 bg-slate-800 rounded-xl border border-slate-700\">\n                <strong>Problem-Solution:</strong> States a challenge and presents the solution. Best for business pitches.\n              </div>\n              <div class=\"p-3 bg-slate-800 rounded-xl border border-slate-700\">\n                <strong>Topical:</strong> Divides the topic into categories. Best for lectures.\n              </div>\n            </div>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "Which presentation pattern is best suited for proposing a new business product?",
        "options": [
        ...
        "answer": 2,
        "explanation": "Proposing a product requires identifying a market pain point (problem) and showing how your product resolves it (solution)."
      },
      {
        "question": "What is a recommended strategy for handling difficult questions during Q&A?",
        "options": [
          "Arguing aggressively with the questioner.",
          "Listening fully, acknowledging the question, and answering honestly or offering to follow up.",
          "Refusing to answer any questions.",
          "Leaving the stage immediately."
        ],
        "answer": 1,
        "explanation": "Listening carefully and responding politely maintains credibility, even if you don't know the answer immediately."
      },
      {
        "question": "Chronological patterns organize information based on:",
        "options": [
          "Importance of points.",
          "Timeline or sequential order of events.",
          "Geographical location.",
          "Opposing arguments."
        ],
        "answer": 1,
        "explanation": "Chronological structures arrange details sequentially, from earliest to latest or step-by-step."
      }
    ]
  },
  {
    ...
    "youtubeId": "",
    "objectives": [
      "Learn advanced presentation delivery dynamics (kinesics, haptics, vocal modulation).",
      "Explore how to handle presentation tools (pointers, remotes).",
      "Understand the role of team presentations and seamless handovers."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-800\">TEAM PRESENTATIONS & INSTRUMENTS</h3>\n            <p class=\"text-sm text-slate-500 mt-1\">Achieving professionalism and team coordination on stage.</p>\n          </div>\n\n          <div class=\"bg-white p-6 rounded-2xl border border-slate-200 space-y-4\">\n            <h4 class=\"font-bold text-slate-850 text-sm\">Seamless Handover in Team Presentations</h4>\n            <p class=\"text-xs text-slate-655 leading-relaxed\">\n              When presenting in a group, transition cleanly between speakers. Use sentences like: <br>\n              <span class=\"italic text-amber-600 font-semibold\">\"Now, I will hand over to my teammate Rajesh, who will walk you through the financial projections...\"</span>\n            </p>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "In a team presentation, how should transitions between speakers be handled?",
        "options": [
          "By walking away without saying anything.",
          "By introducing the next speaker and their topic clearly.",
          "By shouting the next speaker's name.",
          "By ending the slide show."
        ],
        "answer": 1,
        "explanation": "Clean transitions maintain the flow and show preparation and respect among team members."
      },
      {
        "question": "When using a laser pointer during a presentation, you should:",
        "options": [
          "Wave it rapidly across the screen.",
          "Point it steadily at the specific item you are discussing, then turn it off.",
          "Shine it at the audience's eyes.",
          "Keep it turned on throughout the entire speech."
        ],
        "answer": 1,
        "explanation": "Laser pointers must be used selectively and steadily; rapid movement distracts and makes you look nervous."
      },
      {
        "question": "To make an effective presentation, a speaker must:",
        "options": [
          "Read word-for-word from a manuscript.",
          "Align slide content, vocal modulation, and open body language.",
          "Avoid looking at the audience.",
          "Use as many technical abbreviations as possible."
        ],
        "answer": 1,
        "explanation": "Delivery depends on the synthesis of slides, voice, and physical presence."
      }
    ]
  },
  {
    "id": 53,
    "week": 11,
    "title": "Speeches for Various Occasions",
    "youtubeId": "",
    "objectives": [
      "Learn standard occasion speech protocols (welcome address, vote of thanks).",
      "Explore how to introduce a keynote speaker.",
      "Understand tone requirements for celebratory vs. solemn occasions."
    ],
    "notes": "\n        <div class=\"space-y-6\">\n          <div class=\"border-l-4 border-amber-500 pl-4\">\n            <h3 class=\"text-xl font-bold text-slate-805\">OCCASION PROTOCOLS</h3>\n            <p class=\"text-xs text-slate-500 mt-1\">Formulating welcome addresses and formal vote of thanks.</p>\n          </div>\n\n          <div class=\"bg-amber-50/50 p-6 rounded-2xl border border-amber-100/50 text-xs space-y-4\">\n            <h4 class=\"font-bold text-amber-900 text-sm\">Two Essential Occasion Speeches</h4>\n            <p><strong>1. Welcome Address:</strong> Given at the start of an event. Greets guests, introduces the event's theme, and outlines the schedule.</p>\n            <p><strong>2. Vote of Thanks:</strong> Given at the end. Expresses gratitude to the chief guest, organizers, volunteers, and participants.</p>\n          </div>\n        </div>\n      ",
    "quiz": [
      {
        "question": "What is the primary function of a Vote of Thanks speech?",
        "options": [
          "To critique the guest speaker's presentation.",
          "To express official gratitude to guests, organizers, and participants.",
          "To introduce the key themes of the event.",
          "To collect registration fees."
        ],
        "answer": 1,
        "explanation": "A Vote of Thanks is a closing speech acknowledging everyone who contributed to the success of the event."
      },
      {
        "question": "A Welcome Address should typically be delivered:",
        "options": [
          "At the conclusion of the event.",
          "At the beginning of the event.",
          "During the lunch break.",
          "Only after the vote of thanks."
        ],
        "answer": 1,
        "explanation": "The Welcome Address opens the event, greeting the audience and setting the stage."
      },
      {
        "question": "When introducing a guest speaker, you should focus on:",
        "options": [
          "Your own academic background.",
          "The speaker's relevant credentials, achievements, and the title of their talk.",
          "The menu of the upcoming dinner.",
          "A long history of the host institution."
        ],
        "answer": 1,
        "explanation": "A speaker introduction must be brief, highlighting why the speaker is qualified to talk on the subject."
      }
    ]
  },
  {
